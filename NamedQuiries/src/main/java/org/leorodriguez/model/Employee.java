...
//@namedquery is formatted in name =(name of the function), query = (SQL code)
@NamedQuery(name = "getAllEmployees", query = "select e from Employee e")
//Using @NamedQueries for multiple  HQL
@NamedQueries({//Think of @NamedQueries as a contained for multiple @NamedQuerys
        ...
        @NamedQuery(name = "employeeDeptAlias", query = "select e, e.officeCode , e.name, " +
                "CASE " +//All lines are a seperate string concated together with +
