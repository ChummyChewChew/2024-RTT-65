...
public class PathVariableController {
    ...
    @ResponseBody
    public String handler(@PathVariable(name = "name") String name) {// Binds the URI template variable 'name' to the method parameter
    ...
    @ResponseBody// Indicates that the return value of this method will be the response body
    public String handler(@PathVariable String firstName, @PathVariable String lastName) {// Maps HTTP GET requests to
        // /request2/{firstName}/{lastName} to this method
        return "URL parameters - <br>"// Returns a string including the 'firstName' and 'lastName' parameter values
    ...
    @GetMapping("/request3/{name}/{age}/{salary}/{active}")// Maps HTTP GET requests to
    // /request3/{name}/{age}/{salary}/{active} to this method
    @ResponseBody// Indicates that the return value of this method will be the response body
    // Binds the URI template variables to method parameters, converting them to the appropriate types
    public String handler(@PathVariable("name") String name,
        ...
        return "URL parameters - <br>"
                ...
                + " salary = " + salary
                + " <br>" + " active = " + active;
        // Returns a string including the parameter values
    }
