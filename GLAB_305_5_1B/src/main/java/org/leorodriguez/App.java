...
public class App {
    ...
    public static void manyToMany(){
        ...
        Set<Cohort> ClassSet4 = new HashSet<Cohort>();
        ClassSet4.add(Class1);
        ClassSet4.add(Class2);
        ClassSet4.add(Class3);
        ...
        Teacher t4 = new Teacher("202", "Bob", ClassSet4);
